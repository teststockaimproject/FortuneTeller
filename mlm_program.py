...
def main():
    st.title("FORTUNE TELLER: Stock Analysis with Technical Indicators")
    st.write("Choose a stock, date range, and analysis technique to view technical indicators and signals.")
    st.write("NOTE ON TECHNICAL ANALYSIS TECHNIQUE SELECTOR: Golden/Death Cross requires at least 90 days of data for signals to be available. This will be patched in future updates.")
    st.write("With love from The Lim Family plus Dain <3")
    ...
    if start_date >= end_date:
        ...
        st.write("Read more about what Classification Reports and Confusion Matrices are in these links below")
        st.write("Classification Reports: https://www.scikit-yb.org/en/latest/api/classifier/classification_report.html")
        st.write("Confusion Matrices: https://www.ibm.com/topics/confusion-matrix?mhsrc=ibmsearch_a&mhq=confusion%20matrix")
        st.write("DISCLAIMER: The stock trading signals in this app are for informational purposes only and are not financial advice. Markets are unpredictable, and past performance is no guarantee of future results. Trading involves risk, and users should not rely solely on these signals. Always do your own research, consider your risk tolerance, and consult a licensed financial advisor before trading. This app and its developers are not liable for any losses.")
